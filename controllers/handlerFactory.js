...
exports.updateOne = (Model) =>
  catchAsync(async (req, res, next) => {
    const doc = await Model.findByIdAndUpdate(req.params.id, req.body, {
      ...
      new: true,
      // [options.runValidators] «Boolean» if true, runs update validators on this command.if false then Update validators validate the update operation against the model's schema
